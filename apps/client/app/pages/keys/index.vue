...
useSeoMeta({
  title: 'Таблица ключей китайских иероглифов (214 ключей Канси)',
  ogTitle: 'Таблица ключей китайских иероглифов',
  description: 'Полный список 214 иероглифических ключей с примерами, значениями и произношением. Интерактивная таблица для изучения основ китайской письменности.',
  ogDescription: 'Изучайте 214 ключей Канси. Узнайте их значения, названия и как они используются в составе сложных иероглифов.',
})
